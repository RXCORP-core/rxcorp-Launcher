...
const translations = {
    fr: {
        ...
        wizard_step_lang: "Langue",
        wizard_step_account: "Compte",
        wizard_step_ram: "Mémoire",
        wizard_step_profile: "Profil",
        wizard_lang_desc: "Sélectionnez la langue principale pour l'interface de votre launcher.",
        wizard_account_desc: "Connectez votre compte officiel ou choisissez un pseudo hors-ligne.",
        wizard_ram_desc: "Allouez la mémoire vive recommandée pour Minecraft selon votre configuration.",
        wizard_ram_alloc: "Mémoire Allouée",
        wizard_profile_desc: "Choisissez le profil initial prêt à jouer qui sera installé dans votre launcher.",
    ...
    en: {
        ...
        wizard_step_account: "Account",
        wizard_step_ram: "Memory",
        wizard_step_profile: "Profile",
        wizard_lang_desc: "Select the primary language for your launcher interface.",
        wizard_account_desc: "Link your official Minecraft account or choose an offline username.",
        wizard_ram_desc: "Allocate the recommended RAM for Minecraft based on your hardware.",
        wizard_ram_alloc: "Allocated Memory",
        wizard_profile_desc: "Choose the ready-to-play starter profile to install in your launcher.",
    ...
    es: {
        ...
        wizard_step_lang: "Idioma",
        wizard_step_account: "Cuenta",
        wizard_step_ram: "Memoria",
        wizard_step_profile: "Perfil",
        wizard_lang_desc: "Selecciona el idioma principal para la interfaz de tu launcher.",
        wizard_account_desc: "Conecta tu cuenta oficial o elige un nombre de usuario sin conexión.",
        wizard_ram_desc: "Asigna la memoria RAM recomendada para Minecraft según tu equipo.",
        wizard_ram_alloc: "Memoria Asignada",
        wizard_profile_desc: "Elige el perfil inicial listo para jugar que se instalará en tu launcher.",
    ...
    de: {
        ...
        wizard_step_lang: "Sprache",
        wizard_step_account: "Konto",
        wizard_step_ram: "Speicher",
        wizard_step_profile: "Profil",
        wizard_lang_desc: "Wähle die Hauptsprache für die Benutzeroberfläche deines Launchers.",
        wizard_account_desc: "Verknüpfe dein offizielles Konto oder wähle einen Offline-Benutzernamen.",
        wizard_ram_desc: "Weise den empfohlenen Arbeitsspeicher für Minecraft basierend auf deiner Hardware zu.",
        wizard_ram_alloc: "Zugewiesener Speicher",
        wizard_profile_desc: "Wähle das sofort einsatzbereite Startprofil, das im Launcher installiert werden soll.",
        wizard_prev: "Zurück",
        wizard_next: "Weiter",
        wizard_finish: "Konfiguration abschließen",
        wizard_or: "ODER",
    ...
    pt: {
        ...
        wizard_step_lang: "Idioma",
        wizard_step_account: "Conta",
        wizard_step_ram: "Memória",
        wizard_step_profile: "Perfil",
        wizard_lang_desc: "Seleciona o idioma principal para a interface do teu inicializador.",
        wizard_account_desc: "Liga a tua conta oficial ou escolhe um nome de utilizador offline.",
        wizard_ram_desc: "Aloca a memória RAM recomendada para o Minecraft de acordo com o teu computador.",
        wizard_ram_alloc: "Memória Alocada",
        wizard_profile_desc: "Escolhe o perfil inicial pronto a jogar que será instalado no teu launcher.",
        wizard_prev: "Anterior",
        wizard_next: "Seguinte",
        wizard_finish: "Concluir Configuração",
        wizard_or: "OU",
        wizard_save: "Confirmar",
        recommended: "Recomendado",
